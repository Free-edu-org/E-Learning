          ...
          <AppDialogBody>
            ...
            {userDialogMode === "create" ? (
              ...
              >
                ...
                >
                  <Collapse
                    in={userDialogEditingFields.includes("username")}
                    unmountOnExit
                  >
                    <Typography
                      variant="caption"
                ...
                >
                  <Collapse
                    in={userDialogEditingFields.includes("email")}
                    unmountOnExit
                  >
                    <Typography
                      variant="caption"
                ...
                {userDialogRole === "STUDENT" && (
                  ...
                  >
                    <Collapse
                      in={userDialogEditingFields.includes("group")}
                      unmountOnExit
                    >
                      <Typography
                        variant="caption"
