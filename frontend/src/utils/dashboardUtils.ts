...
const ERROR_TRANSLATIONS: Record<string, string> = {
  ...
  "An unexpected error occurred": "Wystąpił nieoczekiwany błąd po stronie serwera.",
};
...
const ERROR_CODE_TRANSLATIONS: Record<string, string> = {
  ...
  INTERNAL_SERVER_ERROR: "Wystąpił nieoczekiwany błąd serwera. Spróbuj ponownie później.",
};
